...
_start:
    ...
    cycle_row:              ; внешний цикл для строк
        ...
        mov edx, eax                ; помещаем eax в edx
        shr edx, 16                 ; сдвигаем edx на 2 байта, чтобы в dx лежали старшие разряды eax
        ...
        add rbx, rcx                ; rbx = индекс элемента матрицы, совпадающий с (5 - номер строки, в которой он находится)
        mov [matrix + rbx*4], eax   ; matrix[rbx] = сумма положительных чисел строки
